  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        password,
        options: {
          emailRedirectTo: process.env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/multiverse`,
          data: {
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-950 via-slate-900 to-black flex items-center justify-center p-4">
      ...
      <Card className="relative w-full max-w-md bg-slate-900/80 border-purple-500/20 backdrop-blur-sm z-10">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-slate-400">Create your account to start exploring</CardDescription>
        </CardHeader>
        <CardContent>
